...
void adaboost_metrics(vector<vector <int> > & train_records, vector< vector<int> > & test_records, int max_idx)
{
    ...
    cout << "Accuracy: " << (double)(TP0+TN0)/labels_combined.size() << endl;
    cout << "Error rate: " << (double)(FP0+FN0)/labels_combined.size() << endl;
    ...
    cout << "Accuracy: " << (double)(TP+TN)/labels_combined_test.size() << endl;
    cout << "Error rate: " << (double)(FP+FN)/labels_combined_test.size() << endl;
