...
int main (int argc, char* argv[]) {
    ...
    string trainfile("./poker.train");
    string testfile("./poker.test");
    cout << "File: " << trainfile << endl;
    cout << "Method: Naive Bayes"  << endl;
    cout << "Generating model evaluation metrics..." << endl;
...
cout << "Accuracy: " << (double)(TP0+TN0)/labels0.size() << endl;
cout << "Error rate: " << (double)(FP0+FN0)/labels0.size() << endl;
cout << "Sensitivity: " << (double)TP0/(TP0+FN0) << endl;
cout << "Specificity: " << (double)TN0/(FP0+TN0) << endl;

double precision = (double)TP0/(TP0+FP0);
double recall = (double)TP0/(TP0+FN0);
cout << "Precision: " << precision << endl;

cout << "F1 score: " << (double)(2*precision*recall)/(precision+recall) << endl;

double beta = 0.5;

cout << "F_beta 0.5 score: " << (double)(1+beta*beta)*(2*precision*recall)/((beta*beta)*precision+recall) << endl;

beta = 2;
cout << "F_beta 2 score: " << (double)(1+beta*beta)*(2*precision*recall)/((beta*beta)*precision+recall) << endl;
...
cout << "Accuracy: " << (double)(TP+TN)/labels.size() << endl;
cout << "Error rate: " << (double)(FP+FN)/labels.size() << endl;
cout << "Sensitivity: " << (double)TP/(TP+FN) << endl;
cout << "Specificity: " << (double)TN/(FP+TN) << endl;
